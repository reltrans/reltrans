...
!-----------------------------------------------------------------------
    subroutine tdreltransDCp(ear, ne, param, ifl, photar)
      implicit none
      integer :: ne, ifl, Cp
      real    :: ear(0:ne), param(21), photar(ne)
      real    :: fake_param(20)
      Cp = 2
...
!-----------------------------------------------------------------------
subroutine genreltrans(Cp, ear, ne, param20, param21, ifl, photar)
...
!Args:
  ...
  real   , intent(inout) :: param20(20), param21(21)
...
!SAVE 
  ...
  real             :: param20save(20), param21save(21)
...
!Save the first call variables
  ...
  save param20save, param21save, fhisave, flosave, nfsave
...
!Allocate dynamically the array to calculate the trasfer function 
  ...
  call set_param(h, a, inc, rin, rout, zcos, Gamma, logxi, Afe,&
       ...
       DelA, DelAB, g, param20, param21, Cp, resp_matr)
...
!Determine if I need to calculate the kernel
  call kernel_check(Cp, param20, param21, param20save, param21save, fhi, flo, fhisave, flosave, nf, nfsave, needtrans)
