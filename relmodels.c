...
void xillver_base(const double *ener0, const int n_ener0, double *photar, xillParam *param_struct, int *status) {
  ...
  //renorm_xill_spec(flux, n_ener0, param_struct->lxi, param_struct->dens);
...
void i_tdxillverdens_nthcomp(const double *ener0,
                           const int n_ener0,
                           double *photar,
                           const double *parameter,
                           const int n_parameter,
...
/** XSPEC XILLVER DENS MODEL FUNCTION (intensity version)**/
void i_tdxillverdens(const double *ener0,
                   const int n_ener0,
                   double *photar,
                   const double *parameter,
                   const int n_parameter,
...
/** XSPEC XILLVER DENS MODEL FUNCTION (intensity version)**/
void i_tdxillver(const double *ener0,
               const int n_ener0,
               double *photar,
               const double *parameter,
               const int n_parameter,
...
void lmodxillverdensnthcompf_(const double* ener0, const int *n_ener0, const double* parameter, int *ifl, double* photar, double* photer, const char* init){
  ...
  i_tdxillverdens_nthcomp(ener0, *n_ener0, photar, parameter, n_parameter, &status);
