...
photar_fft = ib.reltransDCp(ear, param)
os.environ["TEST_RUN" ] = "1"
photar_fftw = ib.reltransDCp(ear, param)
...
ax.plot(E, photar_fft/dE , lw = 5, color = 'blue', ls = '--', label = 'reltrans TEST FT')
ax.plot(E, photar_fftw/dE, lw = 5, color = 'red' , ls = '-.' , label = 'reltrans FFFTw')
...
#             ax.plot(E, photar/dE     , lw = 5, color = 'blue', ls = '-' , label = 'reltrans spectrum')
#             ax.plot(E, photar_test/dE, lw = 5, color = 'red' , ls = '--', label = 'reltrans test run = 0')
